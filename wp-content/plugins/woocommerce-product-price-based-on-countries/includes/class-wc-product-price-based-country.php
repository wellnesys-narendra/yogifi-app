...
class WC_Product_Price_Based_Country {
	...
	public function load_textdomain() {
		load_plugin_textdomain( 'woocommerce-product-price-based-on-countries', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
	}
	...
	private function is_ajax_frontend() {
		...
		if ( ! empty( $http_referer ) ) {
			...
			$is_ajax_frontend = ( false === strpos( $http_referer, $admin_url ) );
		} else {
