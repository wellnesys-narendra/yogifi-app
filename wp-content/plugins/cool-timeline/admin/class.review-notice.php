...
if (!class_exists('ReviewNotice')) {
	...
	public function load_script() {
		wp_register_script( 'feedback-notice-script', COOL_TIMELINE_PLUGIN_URL. 'assets/js/ctl-admin-feedback-notice.js', array( 'jquery' ),null, true );
        wp_enqueue_script( 'feedback-notice-script' );
        wp_register_style( 'feedback-notice-styles',COOL_TIMELINE_PLUGIN_URL.'assets/css/ctl-admin-feedback-notice.css' );
