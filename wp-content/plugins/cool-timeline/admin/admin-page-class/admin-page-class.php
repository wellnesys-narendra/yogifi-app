  ...
  class BF_Admin_Page_Class {
    ...
    public function AddMenuTopPage() {
      $default = array(
        ...
        'id'         => 'id',
       'icon_url'   => COOL_TIMELINE_PLUGIN_URL.'assets/images/timeline-icon-small.png',
        'position'   => null
      );
    ...
    public function DisplayPage() {
      ...
      echo '<form method="post" name="'.apply_filters('apc_form_name', 'admin_page_class',$this).'" class="'.apply_filters('apc_form_class', 'admin_page_class',$this).'" id="'.apply_filters('apc_form_id', 'admin_page_class',$this).'" action="" enctype="multipart/form-data">
        ...
        echo '<img style="vertical-align:middle;width:50%;" src="'.COOL_TIMELINE_PLUGIN_URL.'assets/images/cool-timeline-new-logo.png">
        '."\n".((isset($this->args['page_header_text']))? $this->args['page_header_text'] : '').' 
        </div>'."\n".'
        <div style="float:right;margin:32px 0 0 0"> <span>V '.COOL_TIMELINE_CURRENT_VERSION.'</span>'."\n".'
    ...
    <img src="' . COOL_TIMELINE_PLUGIN_URL . 'assets/images/cool-timeline-new-logo.png"></a>
    </div>
    <hr>  
    <div>
