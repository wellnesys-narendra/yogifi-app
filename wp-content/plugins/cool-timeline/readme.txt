...
### Elementor Timeline Widget Addon For Elementor Lovers
Check it:-  [Timeline Widget For Elementor](https://wordpress.org/plugins/timeline-widget-addon-for-elementor/#description) 

https://youtu.be/_pVKlMxL1ro
...
* Improved:Improved featured image code
* Improved:Excerpt length functions
* Improved: user review class code 
= Version 1.9.1 | Oct 23, 2019 =
* Fixed: story icon not displaying issue
* Fixed: undefined notice in horizontal timeline
* Fixed: Timeline overlapping sidebar
* Imporved: Improved wrong translated
