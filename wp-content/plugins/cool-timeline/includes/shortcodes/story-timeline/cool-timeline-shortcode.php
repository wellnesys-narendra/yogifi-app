		 ...
		 $story_img_link = '<a title="' . esc_attr(get_the_title($post_id)). '"  href="' .esc_url($img_f_url). '" class="ctl_prettyPhoto">';
		    ...
		    if ( has_post_thumbnail($post_id) ) {
				if ($img_cont_size == "small"){
					$contCls='pull-left';
		      		$img=get_the_post_thumbnail( $post_id,apply_filters('cool_timeline_story_img_size','thumbnail'), array( 'class' => 'story-img left_small','alt'=>$alt_text) );
				 } else {
					$contCls='full-width';
		...
		*/
        ...
        if(is_array($selected_fonts)){
           ...
           if(is_array($gfont_arr)){
			...
			wp_register_style('ctl-styles', COOL_TIMELINE_PLUGIN_URL . 'assets/css/ctl_styles.min.css',null, null,'all' );	
		
		  	// register popup assets
			wp_register_style('ctl-prettyPhoto', COOL_TIMELINE_PLUGIN_URL . 'assets/css/prettyPhoto.css', null, null, 'all');
			wp_register_script('ctl-prettyPhoto', COOL_TIMELINE_PLUGIN_URL . 'assets/js/jquery.prettyPhoto.js', array('jquery'), null, true);  
			...
			wp_register_script('ctl-scripts', COOL_TIMELINE_PLUGIN_URL . 'assets/js/ctl_scripts.min.js', array('jquery'), null, false);
			wp_register_script('ctl-horizontal-tm-js', COOL_TIMELINE_PLUGIN_URL . 'assets/js/ctl_hori_scripts.min.js', array('jquery'), null, false);
			// load settings for compacy layout
			wp_register_script('ctl-masonry', COOL_TIMELINE_PLUGIN_URL . 'assets/js/masonry.pkgd.min.js', array('jquery'), false, false);
			wp_register_script('ctl-compact-js', COOL_TIMELINE_PLUGIN_URL . 'assets/js/ctl_compact_scripts.min.js', array('jquery','ctl-masonry'), false, false);
		  	// on scroll animations 
			wp_register_style('aos-css',COOL_TIMELINE_PLUGIN_URL. 'assets/css/aos.css', null, null, 'all');
			wp_register_script('aos-js', COOL_TIMELINE_PLUGIN_URL . 'assets/js/aos.js', array('jquery'), null, true);
