...
function wpb_ea_admin_menu() {
	add_menu_page( esc_html__( 'About WPB Elementor Addons', 'wpb-elementor-addons' ), esc_html__( 'WPB EA Addons', 'wpb-elementor-addons' ), 'delete_posts', 'wpb-ea-about', 'wpb_ea_admin_about_page', 'dashicons-lightbulb', 90  );
}
